    ...
    <body>
        ...
        <?php if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['numRows'])): ?>
            <?php
                ...
                if ($numRows < 1): ?>
                    <div id="errorCard" class="card position-absolute top-0 start-50 translate-middle-x" style="width: 1200px; margin-top: 425px; background-color: #f8d7da;">
                        <div class="card-body">
                            ...
                            <p class="fs-4 mb-0" style="font-size: 18px; color: #842029;">Please enter a number greater than or equal to 1.</p>
                ...
                ?>
                <div id="pascalCard" class="card position-absolute top-0 start-50 translate-middle-x" style="width: 1500px; margin-top: 425px; background-color: #fbf3d5;">
                    <div class="card-body">
